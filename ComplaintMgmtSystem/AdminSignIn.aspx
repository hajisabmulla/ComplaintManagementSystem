<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminSignIn.aspx.cs" Inherits="ComplaintMgmtSystem.AdminSignIn" %>
...
<body>
    <form id="form1" runat="server">
        <div class="auto-style1">
            <h1 class="auto-style2"><strong>Admin Sign in</strong></h1>
        </div>
